...
subfolder='...'
##theNewTag='MDm'
##subfolder='musikk_tablet/samba'
##musicDir='/storage/sdcard1/music'

path = 'storage/sdcard0/com.hipipal.qpyplus/scripts/PlaylistCreator/musicForTagging/'+subfolder
#path = 'C:/Users/Atrakatz/Desktop/New folder/'+subfolder
#path = 'C:/Users/Atrakatz/Downloads/mp3'
os.chdir(path)
...
def addTagToFileName(fileName, newTag):
    separatedFilename, fileName = splitTagIfOkTagSetup(fileName)
